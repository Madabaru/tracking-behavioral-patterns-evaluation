...
XTITLE = "Max Trace Length" # "Number of Target Traces" # "Number of Observed Traces K" 
...
x = subset_df["max_trace_len"].values  # trace_sample_size # target_trace_sample_size
