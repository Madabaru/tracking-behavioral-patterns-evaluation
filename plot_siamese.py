...
# Siamese network-based Approach # Comparison
APPROACH = "Siamese network-based Approach"
...
x = ["(TL, Random)", "(TL, Semi-Hard)", "(TL, Hard)", "(CL, Random)",
     "(CL, Semi-Hard)", "(CL, Hard)"]  # CHANGE HERE
