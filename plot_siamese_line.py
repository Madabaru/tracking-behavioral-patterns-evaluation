...
# Number of Linkage Attacks # Number of Observed Traces K
XTITLE = "Number of Observed Traces K"
...
# trace_sample_size # client_sample_size
x = subset_df["trace_sample_size"].values
