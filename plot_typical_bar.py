...
x = ["Typical", "Not Typical", "Typical", "Not Typical", "Typical", "Not Typical", "Typical", "Not Typical"]
...
ax1.bar(top_1_bar, top_1[0:2], width=BAR_WIDTH, color="#3f51b5", yerr=ci_top_1[0:2], capsize=3, label="Top 1")
ax1.bar(top_10_bar, top_10[0:2], width=BAR_WIDTH, color="#f44336", yerr=ci_top_10[0:2], capsize=3, label="Top 10")
ax1.bar(top_10_percent_bar, top_10_percent[0:2], width=BAR_WIDTH, color="#9e9e9e", yerr=ci_top_10_percent[0:2], capsize=3, label="Top 10%")
ax1.set_xticks([0.2, 1.2])
ax1.set_xticklabels(["Typical", "Not Typical"])
ax1.set_title("K = 5", fontsize=12)
ax1.set(ylabel='Probability')

ax2.bar(top_1_bar, top_1[2:4], width=BAR_WIDTH, color="#3f51b5", yerr=ci_top_1[2:4], capsize=3, label="Top 1")
ax2.bar(top_10_bar, top_10[2:4], width=BAR_WIDTH, color="#f44336", yerr=ci_top_10[2:4], capsize=3, label="Top 10")
ax2.bar(top_10_percent_bar, top_10_percent[2:4], width=BAR_WIDTH, color="#9e9e9e", yerr=ci_top_10_percent[2:4], capsize=3, label="Top 10%")
ax2.set_xticks([0.2, 1.2])
ax2.set_xticklabels(["Typical", "Not Typical"])
ax2.set_title("K = 10", fontsize=12)

ax3.bar(top_1_bar, top_1[4:6], width=BAR_WIDTH, color="#3f51b5", yerr=ci_top_1[4:6], capsize=3, label="Top 1")
ax3.bar(top_10_bar, top_10[4:6], width=BAR_WIDTH, color="#f44336", yerr=ci_top_10[4:6], capsize=3, label="Top 10")
ax3.bar(top_10_percent_bar, top_10_percent[4:6], width=BAR_WIDTH, color="#9e9e9e", yerr=ci_top_10_percent[4:6], capsize=3, label="Top 10%")
ax3.set_xticks([0.2, 1.2])
ax3.set_xticklabels(["Typical", "Not Typical"])
ax3.set_title("K = 25", fontsize=12)
ax3.set(ylabel='Probability')

ax4.bar(top_1_bar, top_1[6:8], width=BAR_WIDTH, color="#3f51b5", yerr=ci_top_1[6:8], capsize=3, label="Top 1")
ax4.bar(top_10_bar, top_10[6:8], width=BAR_WIDTH, color="#f44336", yerr=ci_top_10[6:8], capsize=3, label="Top 10")
ax4.bar(top_10_percent_bar, top_10_percent[6:8], width=BAR_WIDTH, color="#9e9e9e", yerr=ci_top_10_percent[6:8], capsize=3, label="Top 10%")
